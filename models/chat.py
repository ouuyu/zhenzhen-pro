...
MODEL_MAPPING: Dict[str, Dict[str, Any]] = {
    ...
    "ggg": {"model": "gemini-2.5-flash", "deep_thinking": False},
    "mini": {"model": "MiniMaxAI/MiniMax-M1-80k", "deep_thinking": True},
    "qwen": {"model": "Tongyi-Zhiwen/QwenLong-L1-32B", "deep_thinking": True},
    "baidu": {"model": "baidu/ERNIE-4.5-300B-A47B", "deep_thinking": False}
}
...
class ChatMessageRequest(BaseModel):
    ...
    thinking_budget: Optional[int] = None      # thinking_budget 设置
